...
MAP_AGENT_TO_PATH_OF_SAVED_GAMES = {
    'FoodAgent': ('data/pacmandata/food_training.pkl','data/pacmandata/food_validation.pkl','data/pacmandata/food_test.pkl' ),
    'StopAgent': ('data/pacmandata/stop_training.pkl','data/pacmandata/stop_validation.pkl','data/pacmandata/stop_test.pkl' ),
    'SuicideAgent': ('data/pacmandata/suicide_training.pkl','data/pacmandata/suicide_validation.pkl','data/pacmandata/suicide_test.pkl' ),
    'GoodReflexAgent': ('data/pacmandata/good_reflex_training.pkl','data/pacmandata/good_reflex_validation.pkl','data/pacmandata/good_reflex_test.pkl' ),
    'ContestAgent': ('data/pacmandata/contest_training.pkl','data/pacmandata/contest_validation.pkl', 'data/pacmandata/contest_test.pkl' )
}
# Main harness code
...
def runClassifier(args, options):
    ...
    if(options.data=="pacman"):
        ...
        rawValidationData = samples.loadDataFile("data/facedata/facedatatrain", TEST_SET_SIZE, FACE_DATUM_WIDTH,FACE_DATUM_HEIGHT)
        validationLabels = samples.loadLabelsFile("data/facedata/facedatatrainlabels", TEST_SET_SIZE)
        rawTestData = samples.loadDataFile("data/facedata/facedatatest", TEST_SET_SIZE, FACE_DATUM_WIDTH, FACE_DATUM_HEIGHT)
        testLabels = samples.loadLabelsFile("data/facedata/facedatatestlabels", TEST_SET_SIZE)
    else:
